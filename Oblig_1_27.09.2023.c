...
void kelvinToCelsius(void);
 ...
 int main(){
  ...
  do{
     ...
     valg = meny();
     if (valg == -1) {
        printf("Takk for at du valgte å bruke Fredrik's supertemperaturkonverterer!!\n");
        break;
      }
     ...
     printf("\nVil du kjøre programmet på nytt?: (J/N)\n");
     scanf(" %c", &fortsett);

    }  while(fortsett =='J' || fortsett =='j');
  ...
  void celsiusToKelvin(void){
    ...
    printf("Temperaturen %.2f i kelvin er %.2f\n",celsius, Celsius2Kelvin);
  ...
  void kelvinToCelsius(void){
    float kelvin;
      ...
      printf("Temperaturen %.2f i Celsius er: %.2f\n",kelvin,  Kelvin2Celsius);
  }
  ...
  void celsiusToFahrenheit(void){
    ...
    printf("Temperaturen %.2f i Farenheit tilsvarer: %.2f\n",celsius,  Celsius2Farenheit);
  }
