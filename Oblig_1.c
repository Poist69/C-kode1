...
void kelvinToCelsius(void);
 ...
 int main(){
  ...
  void celsiusToKelvin(void){
    ...
    printf("Temperaturen %f",celsius, "i kelvin er %f\n",  Celsius2Kelvin);
  ...
  void kelvinToCelsius(void){
    float kelvin;
      ...
      printf("Temperaturen %f", kelvin, "i Celsius er: %f\n",  Kelvin2Celsius);
  }
  ...
  void celsiusToFahrenheit(void){
    ...
    printf("Temperaturen","%f", celsius, "i Farenheit tilsvarer: %f\n",  Celsius2Farenheit);
  }
  ...
  void fahrenheitToCelsius(void){
    ...
    printf("Temperaturen","%f",farenheit, "i farenheit tilsvarer: %f\n",  Farenheit2Celsius);
  }    